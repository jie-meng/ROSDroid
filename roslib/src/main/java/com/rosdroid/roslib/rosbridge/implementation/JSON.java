...
import com.rosdroid.roslib.rosbridge.indication.Indication;
import com.rosdroid.roslib.rosbridge.operation.Wrapper;
...
public class JSON {
    ...
    public static String toJSON(Message m) {
        ...
        return jo.toString();                     // JSON-Simple to string
    }
