 ...
 * 
 */
package com.rosdroid.roslib.rosbridge;
...
import com.rosdroid.roslib.rosbridge.implementation.ROSBridgeWebSocketClient;
import com.rosdroid.roslib.rosbridge.operation.Operation;
    ...
    private String getServiceType(String service) throws InterruptedException {
        Service<com.rosdroid.roslib.rosapi.message.Service, Type> serviceTypeService =
                new Service<>("/rosapi/service_type",
                        com.rosdroid.roslib.rosapi.message.Service.class, Type.class, this);
        return serviceTypeService.callBlocking(new com.rosdroid.roslib.rosapi.message.Service(service)).type;
    }
