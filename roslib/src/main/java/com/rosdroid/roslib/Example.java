/**
 * Copyright (c) 2014 rosdroid Systems, Inc.
 * <p>
 ...
 */
package com.rosdroid.roslib;

import com.rosdroid.roslib.message.Clock;
import com.rosdroid.roslib.message.Log;
import com.rosdroid.roslib.rosapi.message.*;
...
public class Example {
    ...
    public static void testService(ROSBridgeClient client) {
        try {
            ...
            Service<com.rosdroid.roslib.rosapi.message.Service, Type> serviceTypeService =
                    new Service<>("/rosapi/service_type",
                            com.rosdroid.roslib.rosapi.message.Service.class, Type.class, client);
            serviceTypeService.verify();
            String type = serviceTypeService.callBlocking(new com.rosdroid.roslib.rosapi.message.Service("/rosapi/service_response_details")).type;
            ...
            com.rosdroid.roslib.Topic<Log> logTopic =
                    new com.rosdroid.roslib.Topic<>("/rosout", Log.class, client);
            logTopic.verify();
